define(function (require, exports, module) {
  ...
  function init() {
    ...
    $("#add-group-button").unbind().click(function () {
      addGroup()
    });
    $("#add-search-button").unbind().click(function () {
      addSearch()
    });
